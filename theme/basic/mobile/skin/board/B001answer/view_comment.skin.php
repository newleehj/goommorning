    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="padding-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0;"<?php } ?>>
        ...
        <div class="cmt_contents">
			...
			<!--
				...
				-->
                <?php if ($list[$i]['is_edit']) { ?><li><a href="<?php echo $c_edit_href;  ?>" onclick="comment_box('<?php echo $comment_id ?>', 'cu'); return false;" class="btn btn_admin" title="수정" style="background-color:#f9f9f9"><i class="oi oi-cog pline"></i></a></li><?php } ?>
                <?php if ($list[$i]['is_del'])  { ?><li><a href="<?php echo $list[$i]['del_link'];  ?>" onclick="return comment_delete();" class="btn btn_admin" title="삭제" style="background-color:#f9f9f9"><i class="oi oi-trash pline"></i></a></li><?php } ?>
            </ul>
            <?php } ?>
        </div>
